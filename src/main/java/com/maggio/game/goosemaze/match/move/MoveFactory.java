...
public class MoveFactory {
    ...
    public WinMove winMove(String player, int firstRoll, int secondRoll, int currentSpace){
        String message = messageSource.getMessage("match.win", player, firstRoll, secondRoll, currentSpace, winCell);
    ...
    public BridgeMove bridgeMove(String player, int firstRoll, int secondRoll, int currentSpace) {
        String message = messageSource.getMessage("match.bridge", player, firstRoll, secondRoll, currentSpace, bridgeSpaceEnd);
    ...
    public GooseMove gooseMove(String player, int firstRoll, int secondRoll, int currentSpace){
        ...
        sb.append(messageSource.getMessage("match.goose", player, firstRoll, secondRoll, currentSpace, newSpace)).append(" ");
    ...
    public Move move(String player, int firstRoll, int secondRoll, int currentSpace){
        int newSpace = firstRoll + secondRoll + currentSpace;
        String message = messageSource.getMessage("match.move", player, firstRoll, secondRoll, currentSpace, newSpace);
    ...
    public BounceMove bounceMove(String player, Integer firstRoll, Integer secondRoll, int currentSpace) {
        ...
        String message = messageSource.getMessage("match.bounce", player, firstRoll, secondRoll, currentSpace, winCell, bounceSpace);
